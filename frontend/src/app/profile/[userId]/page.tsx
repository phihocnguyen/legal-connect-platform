...
export default function ProfilePage() {
  ...
  // Convert UserProfile to User for components
  const user = {
    id: profile.id,
    email: profile.email,
    fullName: profile.fullName,
    avatar: profile.avatar || undefined,
    role: profile.role.toUpperCase() as 'USER' | 'LAWYER' | 'ADMIN',
    lawyerVerified: profile.role === 'LAWYER'
  };
  ...
  return (
    <div className="container mx-auto py-8 space-y-8">
      ...
      <ProfilePosts posts={userPosts} user={user} />
    </div>
  );
}