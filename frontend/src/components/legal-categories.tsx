...
import { LegalCategory, analyzeCategoriesFromDocuments, getTopCategories } from "@/lib/category-utils";
...
export default function LegalCategories({ 
  ...
  const displayCategories = showTopOnly && !showAll 
            ...
            <CardContent className="p-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1 text-xs text-gray-500">
                  ...
                  <span>{((category.count / documents.length) * 100).toFixed(1)}%</span>
                </div>
              </div>
        ...
        <Card className="mt-6 bg-gradient-to-r from-teal-50 to-blue-50">
          <CardContent className="p-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              ...
              <div>
                <div className="text-2xl font-bold text-teal-600">
                  {Math.round(categories.reduce((sum, c) => sum + c.count, 0) / categories.length)}
                </div>
